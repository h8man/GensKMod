...
%ifdef GENS_KMOD
	extern _SpyBadByteRead
	extern _SpyBadWordRead
	extern _SpyBadByteWrite
	extern _SpyBadWordWrite

	extern _SpyZ80NotPaused
%endif
	...
	DECL Genesis_M68K_Write_Byte_Table
		...
		dd M68K_Write_Byte_Bad,		; 0xB00000 - 0xBFFFFF
		dd M68K_Write_Byte_VDP,		; 0xC00000 - 0xCFFFFF
		dd M68K_Write_Byte_Bad,		; 0xD00000 - 0xDFFFFF
	...
	DECL Genesis_M68K_Write_Word_Table
		...
		dd M68K_Write_Word_Bad,		; 0xB00000 - 0xBFFFFF
		dd M68K_Write_Word_VDP,		; 0xC00000 - 0xCFFFFF
		dd M68K_Write_Word_Bad,		; 0xD00000 - 0xDFFFFF
	...
	DECL SegaCD_M68K_Write_Byte_Table
		...
		dd M68K_Write_Byte_Bad,		; 0x100000 - 0x1FFFFF
		dd M68K_Write_Byte_WRam,	; 0x200000 - 0x2FFFFF
		dd M68K_Write_Byte_Bad,		; 0x300000 - 0x3FFFFF
		dd M68K_Write_Byte_Bad,		; 0x400000 - 0x4FFFFF
		dd M68K_Write_Byte_Bad,		; 0x500000 - 0x5FFFFF
		dd M68K_Write_Byte_BRAM,	; 0x600000 - 0x6FFFFF
		dd M68K_Write_Byte_BRAM_W,	; 0x700000 - 0x7FFFFF
		dd M68K_Write_Byte_Bad,		; 0x800000 - 0x8FFFFF
		dd M68K_Write_Byte_Bad,		; 0x900000 - 0x9FFFFF
	...
	DECL SegaCD_M68K_Write_Word_Table
		...
		dd M68K_Write_Word_Bad,		; 0x100000 - 0x1FFFFF
		dd M68K_Write_Word_WRam,	; 0x200000 - 0x2FFFFF
		dd M68K_Write_Word_Bad,		; 0x300000 - 0x3FFFFF
		dd M68K_Write_Word_Bad,		; 0x400000 - 0x4FFFFF
		dd M68K_Write_Word_Bad,		; 0x500000 - 0x5FFFFF
		dd M68K_Write_Word_BRAM,	; 0x600000 - 0x6FFFFF
		dd M68K_Write_Word_BRAM_W,	; 0x700000 - 0x7FFFFF
		dd M68K_Write_Word_Bad,		; 0x800000 - 0x8FFFFF
		dd M68K_Write_Word_Bad,		; 0x900000 - 0x9FFFFF
	...
	DECL _32X_M68K_Write_Byte_Table
		dd M68K_Write_Byte_Bad,		; 0x000000 - 0x0FFFFF
		dd M68K_Write_Byte_Bad,		; 0x100000 - 0x1FFFFF
		dd M68K_Write_Byte_SRAM,	; 0x200000 - 0x2FFFFF
		dd M68K_Write_Byte_Bad,		; 0x300000 - 0x3FFFFF
		dd M68K_Write_Byte_Bad,		; 0x400000 - 0x4FFFFF
		dd M68K_Write_Byte_Bad,		; 0x500000 - 0x5FFFFF
		dd M68K_Write_Byte_Bad,		; 0x600000 - 0x6FFFFF
	...
	DECL _32X_M68K_Write_Word_Table
		dd M68K_Write_Word_Bad,		; 0x000000 - 0x0FFFFF
		dd M68K_Write_Word_Bad,		; 0x100000 - 0x1FFFFF
		dd M68K_Write_Word_SRAM,	; 0x200000 - 0x2FFFFF
		dd M68K_Write_Word_Bad,		; 0x300000 - 0x3FFFFF
		dd M68K_Write_Word_Bad,		; 0x400000 - 0x4FFFFF
		dd M68K_Write_Word_Bad,		; 0x500000 - 0x5FFFFF
		dd M68K_Write_Word_Bad,		; 0x600000 - 0x6FFFFF
	...
	DECL M68K_Write_Byte_Table
		times 16	dd M68K_Write_Byte_Bad

	DECL M68K_Write_Word_Table
		times 16	dd M68K_Write_Word_Bad
...
%endif
	...
	global M68K_Write_Byte_Bad

	M68K_Write_Byte_Bad:
%ifdef GENS_KMOD
		push ebx
		call _SpyBadByteWrite
		pop ebx
%endif
		pop ecx
		pop ebx
	...
	M68K_Write_Byte_SRAM:
		test dword [SRAM_ON], 1
		jz short M68K_Write_Byte_Bad
		test dword [SRAM_Write], 1
		jz short M68K_Write_Byte_Bad
		cmp ebx, [SRAM_Start]
		jb short  M68K_Write_Byte_Bad
		cmp ebx, [SRAM_End]
...
%endif
	...
	global M68K_Write_Word_Bad

	M68K_Write_Word_Bad:
%ifdef GENS_KMOD
		push ebx
		call _SpyBadWordWrite
		pop ebx
%endif
		pop ecx
		pop ebx
	...
	M68K_Write_Word_SRAM:
		test dword [SRAM_ON], 1
		jz short M68K_Write_Word_Bad
		test dword [SRAM_Write], 1
		jz short M68K_Write_Word_Bad
		cmp ebx, [SRAM_Start]
		jb short M68K_Write_Word_Bad
		cmp ebx, [SRAM_End]
		ja short M68K_Write_Word_Bad
