...
section .bss align=64
	...
	resd 1
	DECL CRam_Flag ; active le rafraichissement des palettes (cf UPDATE_PALETTE in Render_Line)
	resd 1
	DECL VRam_Flag
	resd 1
...
%ifdef GENS_KMOD
		dd	Set_Regs.Special, Set_Regs.Special, Set_Regs.Special, Set_Regs.Special
		dd	Set_Regs.Special, Set_Regs.Special, Set_Regs.Special, Set_Regs.Special
%else
